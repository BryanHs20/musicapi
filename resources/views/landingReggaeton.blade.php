			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
							...
							@foreach($musicasreggaeton as $reggaeton)
								<section>
									<a href="#" class="image">
										<img src="{{$reggaeton['Portada']}}" alt="" data-position="center center" />
									</a>
									<div class="content">
										<div class="inner">
											<header class="major">
												<h3>{{$reggaeton['Titulo']}}</h3>
											</header>
											<p>Duracion: {{$reggaeton['Duracion']}}</p>
											<ul class="actions">
